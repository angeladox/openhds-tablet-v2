...
public class StateMachine {
    ...
    public enum State {
        SELECT_HIERARCHY_1, SELECT_HIERARCHY_2, SELECT_HIERARCHY_3, SELECT_HIERARCHY_4, 
        SELECT_HIERARCHY_5, SELECT_HIERARCHY_6, SELECT_HIERARCHY_7, SELECT_HIERARCHY_8, SELECT_HIERARCHY_9, 
        SELECT_ROUND, SELECT_LOCATION, CREATE_VISIT, SELECT_INDIVIDUAL, SELECT_EVENT, FINISH_VISIT
    }
    ...
    static {
        ...
        STATE_SEQUENCE.add(State.SELECT_HIERARCHY_6);
        STATE_SEQUENCE.add(State.SELECT_HIERARCHY_7);
        STATE_SEQUENCE.add(State.SELECT_HIERARCHY_8);
        STATE_SEQUENCE.add(State.SELECT_HIERARCHY_9);
